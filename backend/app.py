    ...
    try:
        ...
        payload_gc = {
            ...
            'messages': [
                {
                    'role': 'system',
                    'content': 'Ты профессиональный банковский менеджер Альфа-Банка. Отвечай вежливо, профессионально и по делу. Будь кратким и конкретным. Помогай клиентам с банковскими вопросами, услугами и продуктами банка.'
                },
                {
                    'role': 'user',
                    'content': text
